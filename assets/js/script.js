 ...
 * the returned calculatoeCorrectAnswer array 
 */
...
if (isCorrect){
    ...
    alert(`aww. you answerd ${userAnswer}. The correct answer was ${calculatedAnswer[0]!}`)
...
function incrementWrongAnswer() {
    ...
    document.getElementById('incorect').innerText = incorectScore + 1;
